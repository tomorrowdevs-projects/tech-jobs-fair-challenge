...
const CardComponent = () => {
  ...
  return (
    <div className="card">
      ...
      <button className="edit-button" onClick={handleEditClick} aria-label="Edit">
      ...
      {showEditCard && <EditCard onClose={handleCloseEditCard} />}
      </div>
      
      <div className="card-header">
        <img className="card-avatar" src="https://thispersondoesnotexist.com/" alt="avatar" />
        <h1 className="card-fullname">Andrea Rossi</h1>
        <h2 className="card-roletitle">Manager</h2>
      </div>
